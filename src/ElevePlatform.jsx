...
import { buildEleveInvitePath, buildEleveStudentAppPath, calculateEleveMetrics, createEleveInvite, eleveAdminRoles, eleveRoles, hydrateEleveState, planAllowsAppointment, scopeEleveStudents, upsertEleveAssessment, upsertEleveSatisfaction, upsertEleveWorkout } from './elevePlatformData.js'
...
function ElevePlatform() {
  ...
  function setState(next, action = 'Dados operacionais atualizados') {
    ...
    setStateRaw(audited); localStorage.setItem(STORAGE_KEY, JSON.stringify(audited))
  }
