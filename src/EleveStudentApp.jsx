...
function StudentHome({ state, student, plan, trainer, workout, setTab }) {
  ...
  return <>
    <section className="esaHero">
      <div className="esaHeroMedia"><img src="/athlete.jpg" alt="Aluno treinando" /></div>
    ...
    <section className="esaCard esaToday">
      <img className="esaTodayImage" src="/workout.jpg" alt="Treino em destaque" />
